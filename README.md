...
- [lightpanda-io/gomcp](https://github.com/lightpanda-io/gomcp) 🎖️🏎️ - an MCP server which auto downloads and starts Lightpanda, the headless browser optimized for web automation in Zig
